...
autoencoder.save_weights('model_5l_weight_lung_unet_multi.hdf5')
...
layer7_filters = 128
layer8_filters = 64
test_data, test_data1, test_label = prep_data1('test', autoencoder1)
score = autoencoder.evaluate([test_data, test_data1], test_label, verbose=1)
